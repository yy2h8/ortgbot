...
from src.domain.dto import OpenRouterResponse, ConversationPrompt
...
class MessageGenerationService:
    ...
    async def _prepare_context(
        ...
        return conversation_messages, formatted_trend, formatted_context
    ...
    async def reply_to_message(self, group: Group, message: Message) -> str:
        conversation_messages, trends, context = await self._prepare_context(group, message)
